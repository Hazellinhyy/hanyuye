...
ALTER TABLE t_notice ADD COLUMN IF NOT EXISTS image_url VARCHAR(255);
ALTER TABLE t_notice ADD COLUMN IF NOT EXISTS target_roles VARCHAR(120) NOT NULL DEFAULT 'STUDENT,VOLUNTEER,HOSPITAL,ADMIN';
